...
* Design Patterns Game (на будущее) https://designpatternsgame.com/
...
# Задачи и тесты по JavaScript
* Codewars https://www.codewars.com/trainer/  
* Разбор задач Hoisting and types https://youtu.be/uYGW-sAC7PU
* Разбор теста по JS https://youtu.be/mx89ay3YGmU
* Задачи из книги "Выразительный javascript" http://www.itmathrepetitor.ru/zadachi-po-javascript-iz-knigi-vyrazitelnyjj-javascript/
* Что за черт, Javascript https://itnan.ru/post.php?c=1&p=335292
* WTF JS https://wtfjs.com/

# Проекты по JavaScript
* JavaScript30 (en) https://javascript30.com/
* Первая программа (Калькулятор на JavaScript) https://youtu.be/VHGaBc9OcXU
* Collection-of-Website-Works https://github.com/ynyeh0221/Collection-of-Website-Works
